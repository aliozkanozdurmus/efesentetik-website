...
const news = [
  ...
  {
    id: 2,
    title: "Tuna Sentetik'ten Çevre Dostu Yeni Ürün: Biyobozunur Çuvallar",
    ...
    content: `
      ...
      <p>Tuna Sentetik olarak, gelecek nesillere daha yaşanabilir bir dünya bırakmak için çevre dostu ürün yelpazemizi genişletmeye devam edeceğiz.</p>
    `,
  },
  {
    id: 3,
    title: "Tuna Sentetik İhracatta Rekor Kırdı",
    ...
    content: `
      ...
      <p>Tuna Sentetik olarak, ihracat odaklı büyüme stratejimiz doğrultusunda yeni pazarlara açılmaya ve Türkiye ekonomisine katkı sağlamaya devam edeceğiz.</p>
    `,
  },
]
...
export default function NewsSection() {
  ...
  return (
    <section id="news" className="py-20 relative overflow-hidden bg-gradient-to-br from-navy-50 via-white to-navy-50">
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute right-0 top-0 h-[300px] w-[300px] bg-red-200/30 blur-[80px]" />
      </div>

      <div className="container mx-auto relative z-10">
        <SectionTitle title="Haberler" subtitle="Tuna Sentetik'ten son gelişmeler ve duyurular" />

        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {news.map((item, index) => (
            <motion.div
              key={item.id}
              className="bg-white rounded-lg overflow-hidden shadow-lg border border-navy-100 cursor-pointer hover:shadow-xl transition-all duration-300"
