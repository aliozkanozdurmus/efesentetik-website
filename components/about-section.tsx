  ...
  return (
    <section id="about" ref={sectionRef} className="py-20 relative overflow-hidden bg-white">
      ...
      <div className="container mx-auto relative z-10">
        <SectionTitle
          title="Hakkımızda"
          subtitle="Efe Sentetik olarak Gaziantep'te kurulduğumuz günden bu yana kaliteli çuval üretimi konusunda sektörün öncülerinden biri olmayı başardık."
        />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16">
          ...
          >
            <h3 className="text-2xl font-bold gradient-text">Efe Sentetik Hikayesi</h3>
          ...
          >
            {features.map((feature, index) => (
              <motion.div
                key={index}
                className="bg-white p-6 rounded-lg shadow-md border border-brown-100 fancy-border"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="space-y-4">
              <div className="bg-gradient-to-br from-brown-50 to-brown-100 p-6 rounded-lg shadow-md">
